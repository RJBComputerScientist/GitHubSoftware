...
./trait-notify.pl -t effects > EMF/common/scripted_effects/emf_notify_codegen_effects.txt
./trait-notify.pl -t events > EMF/events/emf_notify_codegen.txt
./trait-notify.pl -t localisation > EMF/localisation/1_emf_notify_codegen.csv
