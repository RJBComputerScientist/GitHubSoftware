...
--Table used to hold login information for our users. This references the lama_id table simply to show how
--we can relate logging in to other tables which are associated with different 'roles'
CREATE TABLE login(
	login_id SERIAL PRIMARY KEY,
	lama_id INTEGER REFERENCES examples.lamas(lama_id),
